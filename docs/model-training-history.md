...
**개인 노트북 급 장비에서 7B → 14B → 32B → 72B → 123B(100B급) LoRA 학습을 순차 실증**했다.
...
| 상한 | 8GB → **7B가 사실상 천장** | 통합 60GB+스왑 → **123B(100B급)까지** |
...
| 72B | HQQ **4bit** | ROCm | 🔄 학습중(마지막) | seq1024, Q2보다 무거운 44.4GB (통합풀 마진 얇음) |
