...
interface DetailType {
  // Define the properties of detail object here.
  id?: number | null;
  resourceName?: string | null;
  // ...
}

function EgovAdminDataAccessEdit(props: Props) {
            ...
            <div className='board_btn_area'>
              <div className='left_col btn1'>
                ...
                {modeInfo.mode === CODE.MODE_MODIFY && (
                  <button className='btn btn_skyblue_h46 w_100' onClick={() => deleteBoard(String(detail.uniqId))}>
                    삭제
                  </button>
                )}
              </div>
              ...
              <div className='right_col btn1'>
                <Link to={URL.ADMIN_DATAACCESS} className='btn btn_blue_h46 w_100'>
                  목록
                </Link>
              </div>
            </div>
