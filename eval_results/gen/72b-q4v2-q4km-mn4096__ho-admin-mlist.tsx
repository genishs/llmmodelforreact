      ...
      EgovNet.requestFetch(
        ...
        (resp: { result: any }) => {
          ...
          if (!resp.result.resultList || resp.result.resultList.length === 0) {
            ...
            resp.result.resultList.forEach(function (item: any, index: number) {
              let authNm = "";
        ...
        <div className="w1200">
          <div className="nav_wrap d_flex d_end">
            <div className="nav d_flex d_end">
              <Link to={URL.MAIN}>
                <div className="nav_ico img_all"></div>
              </Link>
              <div className="nav_ico_arr img_all"></div>
              <Link to={URL.ADMIN}>
                <div className="nav_txt">시스템 운영관리</div>
              </Link>
              <div className="nav_ico_arr img_all"></div>
              <Link>
                <div className="nav_txt">사용자 관리</div>
              </Link>
            </div>
          </div>
          <div>
            ...
            <div className="mid_find d_flex d_jcc aic">
              <label className="font20" htmlFor="user-name">
                검색유형 선택
              </label>
              <select
                className="mid_sel"
              ...
              <label htmlFor="user1" className="font20">
                검색어
              </label>
              <input
                id="user1"
